...
def main(argv):
    start = time.time()
    image_width = 224
    training_path = r'F:\313\wky\temp\ODIR-5K_Training_Dataset_treated' + '_' + str(image_width)
    testing_path = r'F:\313\wky\temp\ODIR-5K_Testing_Images_treated' + '_' + '2000' + '_' + str(image_width)
    augmented_path = r'F:\313\wky\temp\ODIR-5K_Training_Dataset_augmented' + '_' + str(image_width)
    csv_file = r'ground_truth\odir.csv'
    csv_augmented_file = r'ground_truth\odir_augmented.csv'
    training_file = r'ground_truth\odir_2000_test.csv'
    ...
    # Generate training file    # 主要实现作者自制验证集的想法，因为当时CHALLENGE官方还未给出验证集标签
