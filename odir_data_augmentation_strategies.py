...
class DataAugmentationStrategy:
    def __init__(self, image_size, file_name):
        ...
        self.file_path = r'F:\313\wky\temp\ODIR-5K_Training_Dataset_treated_' + str(image_size)
        self.saving_path = r'F:\313\wky\temp\ODIR-5K_Training_Dataset_augmented_' + str(image_size)
